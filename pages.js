  ...
  '<body>' +
    '<div id="main-content" class="ms-Grid">' +
      '<div class="ms-Grid-row">' + 
        '<div id="title-banner" class="ms-font-su">Demo</div>' +
      '</div>' +
...
var buttonRow = '<div class="ms-Grid-row">' +
    '<div id="user-email" class="ms-font-l">Te has logueado con : %email%</div>' +
  '</div>' +
  '<div class="ms-Grid-row">' +
    '<div class="ms-Grid-col ms-u-sm4">' +
      '<a class="ms-Button ms-Button--primary" href="/sync"><span class="ms-Button-label">Sincronizar calendario</span></a>' +
    '</div>' +
    '<div class="ms-Grid-col ms-u-sm4">' +
      '<a class="ms-Button ms-Button--primary" href="/refreshtokens"><span class="ms-Button-label">Actualizar tokens</span></a>' +
    '</div>' +
    '<div class="ms-Grid-col ms-u-sm4">' +
      '<a class="ms-Button ms-Button--primary" href="/logout"><span class="ms-Button-label">Desloguear</span></a>' +
    '</div>' +
  '</div>';
...
module.exports = {
  ...
  itemDetailPage: function(userEmail, event) {
    ...
    html += '  </div>';
    html += '  <div class="ms-Grid-col ms-u-sm6">';
    html += '    <a class="ms-Button ms-Button--primary" href="/deleteitem?' + querystring.stringify({ id: event.Id }) + '"><span class="ms-Button-label">Borrar item</span></a>';
    html += '  </div>';
    html += '</div>';
    html += '</form>';
